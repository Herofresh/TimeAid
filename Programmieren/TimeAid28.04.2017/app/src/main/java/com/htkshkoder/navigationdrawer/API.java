...
public class API extends Activity
    ...
    public void getResultsFromApi(Object... param) {
        ...
        if (! isGooglePlayServicesAvailable()) {
            ...
            new MakeRequestTask(mCredential).execute(params);
            params = null;
        }
    }
    ...
    private class MakeRequestTask extends AsyncTask<Object, Void, List<Event>> {
         ...
         * @param params first Object always a int that is the Choice: 1=get Events, 2=create Event, 3=update Event, 4=delete Event, 5=create mult. Events
         ...
         *               second Object case 5: List<Event>, List of Events i want to create
         */
        @Override
        ...
        private void createEvents(List<Event> events) throws IOException {
            String calendarId = "primary";
            for (Event e:events) {
