...
public class Calendar_Logic extends Service{
    ...
    public void saveCalendar_A_Events(String path) throws IOException{
    ...
    public Calendar_Logic loadCalendar_A_Events(String path)throws IOException, ClassNotFoundException{
    ...
    public Vector<Calendar_TimeWindow> filterSuggestedTWs (long toDistributeLength){
